...
def VGG_16(weights_path=None):
    model = Sequential()
    model.add(ZeroPadding2D((1,1),input_shape=(3,108,128)))   #0
...
def load_esc():
    dataX, dataY = pickle.load(open('../../data/esc50.pkl'))
...
if __name__ == "__main__":
    print 'loading data...'
    trainX, trainY, testX, testY = load_esc()
    ...
    '''
    model.fit(trainX, trainY, nb_epoch=4, batch_size=8)
